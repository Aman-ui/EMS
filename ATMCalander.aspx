<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ATMCalander.aspx.cs" Inherits="Timesheetmanagement.ATMCalander" %>
        ...
        <table style="width: 80%">
            <tr>
                <td style="text-align: left">
                     <asp:LinkButton runat="server" Text="Back" CausesValidation="false" ID="lnkLeaveApply" Visible="false"></asp:LinkButton>
