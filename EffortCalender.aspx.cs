...
{
    public partial class EffortCalender : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    if (role.ToLower().Equals("admin"))
                    {
                        ...
                        lnkLeaveApply.PostBackUrl = "~/LeaveRequest.aspx";
                    }
                    else
                    {
        ...
        {
            int Noofdays = 60;// Convert.ToInt32(ConfigurationManager.AppSettings["Cutoffdate"]);
