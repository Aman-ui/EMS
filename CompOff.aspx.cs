...
{
    public partial class CompOff : System.Web.UI.Page
    {
        ...
        {
            DateTime dtfromdate =Convert.ToDateTime(txtCompOffDate.Text).Date;// Cdate((txtFromDate.Text)//  ("dd-MM-YYYY"));
            ...
            cmd.CommandText = "sp_CompOffInsert";
            ...
            cmd.Parameters.AddWithValue("@compoffdate", dtfromdate);
            // cmd.Parameters.AddWithValue("@todate", dttodate);
            cmd.Parameters.AddWithValue("@LeaveType", "Comp-Off");
            ...
            if (i == 1)
            {
                lblRequeststatus.Text = "Comp-Off added Succesfully...";
                clearecontrol();
            }
        }
        ...
        private void BindLeaveType()
        {
            ...
            if (Convert.ToString(Session["Role"]).ToLower() == "admin")
                ...
                ddlResourceName.Enabled = true;

            else
                ddlResourceName.SelectedValue = Convert.ToString(Session["Username"]);
        }
